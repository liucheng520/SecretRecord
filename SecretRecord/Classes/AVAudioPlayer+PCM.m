...
+ (void)pcmPlayerFormatWavWithPcmData:(NSString *)pcmPath pcmFormat:(AudioStreamBasicDescription)pcmFormat
{
    // Following https://ccrma.stanford.edu/courses/422/projects/WaveFormat/ formating wav
    
    NSData *pcmData = [[NSData alloc] initWithContentsOfFile:pcmPath];
    ...
    *((SInt32 *)(wavHeader + 0x28)) = pcmDataLength;
    ...
    [wavData writeToFile:pcmPath atomically:YES];
}
